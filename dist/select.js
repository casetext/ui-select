 ...
 * Version: 0.19.6 - 2017-02-14T00:35:40.882Z
 * License: MIT
 */
...
uis.controller('uiSelectCtrl',
  ...
  ctrl.selectionMade = false; // CASETEXT CUSTOMIZED
  ...
  ctrl.select = function(item, skipFocusser, $event) {
    ...
    ctrl.selectionMade = !!item; // CASETEXT CUSTOMIZED
  ...
  ctrl.searchInput.on('blur', function() {
    ...
    if ((ctrl.items.length > 0) && (!ctrl.multiple || ctrl.open)) {
      ...
      // close (incl. clear) and skip focusser
      ctrl.close(true);
    }
